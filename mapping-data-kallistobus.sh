# download a genome of interest in .fa and .gtf format and merge it with ERCC.fa and ERCC.gtf or find them in my folder /vol/moldevbio/veenstra/asenovska/genomes/GRCh38.p13+ERCC/

# run kallistobus reference to get the .idx file
